...
def index(request):
    ...
    return render(request, "django_simple_forum/list.html", {'forums': forums, 'user': request.user})
...
def forum(request, forum_id):
    ...
    return render(request, "django_simple_forum/forum.html", {'topics': topics, 'pk': forum_id, 'forum': forum})
...
def topic(request, topic_id):
    ...
    return render(request, "django_simple_forum/topic.html", {'posts': posts, 'pk': topic_id, 'topic': topic})
...
def post_reply(request, topic_id):
    ...
    return render(request, 'django_simple_forum/reply.html', {'form': form, 'topic': topic})
